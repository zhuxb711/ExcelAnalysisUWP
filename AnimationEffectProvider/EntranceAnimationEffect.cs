...
namespace AnimationEffectProvider
{
    ...
    {
        private readonly Page BasePageObject;

        private readonly UIElement UIObject;

        private readonly Rect SplashScreenRect;

        public EntranceAnimationEffect(Page BasePageObject, UIElement UIObject, Rect SplashScreenRect)
        {
            this.UIObject = UIObject;
            this.BasePageObject = BasePageObject;
            this.SplashScreenRect = SplashScreenRect;
            SurfaceLoader.Initialize(ElementCompositionPreview.GetElementVisual(BasePageObject).Compositor);
        }
        ...
        {
            ContainerVisual container = (ContainerVisual)ElementCompositionPreview.GetElementChildVisual(BasePageObject);
            ...
            // 设置Grid的中心缩放视觉
            Visual gridVisual = ElementCompositionPreview.GetElementVisual(UIObject);
            gridVisual.Size = UIObject.ActualSize;
            ...
            batch.Completed += (s, a) =>
            {
                ElementCompositionPreview.SetElementChildVisual(BasePageObject, null);
